...
const products = [
  ...
  },
  {
    ...
    image: '/assets/online-laser-detail.jpg',
  ...
  return (
    <div className="perfotec-shell">
      ...
      <header className="site-header">
        <a className="logo" href="#top" onClick={(event) => { event.preventDefault(); scrollTo('top') }} aria-label="PerfoTec home"><img className="brand-logo" src="/assets/perfotec-logo.png" alt="PerfoTec" /></a>
      ...
      <footer className="footer"><a className="logo" href="#top" onClick={(event) => { event.preventDefault(); scrollTo('top') }}><img className="brand-logo" src="/assets/perfotec-logo.png" alt="PerfoTec" /></a><p>Concept direction: a clearer buyer journey for PerfoTec’s public solution ecosystem.</p><div className="footer-right"><a href={contact.linkedin} target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={13} /></a><span>© 2026 PerfoTec</span></div></footer>
